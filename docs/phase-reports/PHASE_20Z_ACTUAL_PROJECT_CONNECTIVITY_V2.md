...
Generated: 2026-07-06T12:05:38.969Z
...
- Broken script imports: 148
- Feature warning(s): Goals / proof / tasks; Health / body / nutrition / sleep / emotion / hair skincare; Life admin / finance / housing / documents; Grimoire
- Created tables without repository read evidence: 8
- Source risk/boundary markers found: 784
- Workspace is dirty. Keep fixing; do not commit yet.
...
| Feature | Phase | Status | Routes | Matching tables | Repository table evidence | Helpers/ViewModels | Components | Route runtime | Boundary label | Blockers | Warnings |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Command dashboard | 0–7 | PASS | /command of [/command] | calendar_blocks<br>goal_milestones<br>goals<br>proof_items<br>tasks | calendar_blocks ← src/lib/repositories/calendar-routine-read.ts<br>routines ← src/lib/repositories/calendar-routine-read.ts<br>routine_steps ← src/lib/repositories/calendar-routine-read.ts<br>reminders ← src/lib/repositories/calendar-routine-read.ts<br>goals ← src/lib/repositories/core-read.ts<br>goal_milestones ← src/lib/repositories/core-read.ts<br>proof_items ← src/lib/repositories/core-read.ts<br>tasks ← src/lib/repositories/core-read.ts | src/lib/analytics-experiments/analytics-dashboard-view-model.ts<br>src/lib/custom-trackers/custom-trackers-dashboard-view-model.ts<br>src/lib/dashboard/admin-finance-dashboard-data-helpers.ts<br>src/lib/dashboard/auth.ts<br>src/lib/dashboard/calendar-routine-dashboard-data-helpers.ts<br>src/lib/dashboard/career-dashboard-data-helpers.ts<br>src/lib/dashboard/career-prep-dashboard-data-helpers.ts<br>src/lib/dashboard/current-info-dashboard-data-helpers.ts<br>src/lib/dashboard/dashboard-card-registry.ts<br>src/lib/dashboard/dashboard-data-helpers.ts<br>src/lib/dashboard/dashboard-layout-contract.ts<br>src/lib/dashboard/grimoire-dashboard-data-helpers.ts | src/components/analytics-experiments/analytics-dashboard-ui.tsx<br>src/components/calendar/calendar-timeline-proposal-composer.tsx<br>src/components/custom-trackers/custom-trackers-dashboard-ui.tsx<br>src/components/dashboard/admin-finance-dashboard-v1.tsx<br>src/components/dashboard/approved-memory-read-layer-panel.tsx<br>src/components/dashboard/authenticated-dashboard-shell.tsx<br>src/components/dashboard/calendar-dashboard-v1.tsx<br>src/components/dashboard/career-current-info-source-panel.tsx<br>src/components/dashboard/career-dashboard-v1.tsx<br>src/components/dashboard/career-evidence-linkage-panel.tsx<br>src/components/dashboard/career-prep-foundation-panel.tsx<br>src/components/dashboard/career-proposed-action-visibility-panel.tsx | yes | yes |  |  |
| Goals / proof / tasks | 2–8 | WARN | /goals of [/goals] | goal_milestones<br>goals<br>project_milestones<br>proof_items<br>tasks | goals ← src/lib/repositories/core-read.ts<br>goal_milestones ← src/lib/repositories/core-read.ts<br>proof_items ← src/lib/repositories/core-read.ts<br>tasks ← src/lib/repositories/core-read.ts<br>project_milestones ← src/lib/repositories/core-read.ts |  | src/components/dashboard/goals-dashboard-v1.tsx<br>src/components/dashboard/proof-dashboard-v1.tsx<br>src/components/goals/goal-proof-proposal-composer.tsx | yes | yes |  | No helper/view-model evidence detected for this domain. |
| Calendar / timeline / routines | 7 / 13 | PASS | /calendar of [/calendar]<br>/timeline of [/timeline] | calendar_blocks<br>reminders<br>routine_steps<br>routines | reminders ← src/lib/repositories/admin-finance-read.ts<br>calendar_blocks ← src/lib/repositories/calendar-routine-read.ts<br>routines ← src/lib/repositories/calendar-routine-read.ts<br>routine_steps ← src/lib/repositories/calendar-routine-read.ts<br>reminders ← src/lib/repositories/calendar-routine-read.ts | src/lib/dashboard/calendar-routine-dashboard-data-helpers.ts | src/components/calendar/calendar-timeline-proposal-composer.tsx<br>src/components/dashboard/calendar-dashboard-v1.tsx<br>src/components/dashboard/timeline-dashboard-v1.tsx | yes | yes |  |  |
| Career / jobs / networking / resume / interviews | 8–9 | PASS | /career of [/career]<br>/networking of [/networking]<br>/resume of [/resume]<br>/interviews of [/interviews] | housing_contacts<br>interviews<br>job_application_events<br>job_applications<br>job_referrals<br>mock_interviews<br>networking_contacts<br>networking_interactions<br>phd_application_assets<br>resume_bullets<br>resume_usage<br>resume_versions | housing_contacts ← src/lib/repositories/admin-finance-read.ts<br>behavioral_stories ← src/lib/repositories/career-prep-read.ts<br>question_bank ← src/lib/repositories/career-prep-read.ts<br>mock_interviews ← src/lib/repositories/career-prep-read.ts<br>resume_usage ← src/lib/repositories/career-prep-read.ts<br>job_applications ← src/lib/repositories/core-read.ts<br>job_application_events ← src/lib/repositories/core-read.ts<br>networking_contacts ← src/lib/repositories/core-read.ts<br>networking_interactions ← src/lib/repositories/core-read.ts<br>job_referrals ← src/lib/repositories/core-read.ts<br>resume_versions ← src/lib/repositories/core-read.ts<br>resume_bullets ← src/lib/repositories/core-read.ts<br>interviews ← src/lib/repositories/core-read.ts<br>phd_application_assets ← src/lib/repositories/research-read.ts | src/lib/dashboard/career-dashboard-data-helpers.ts<br>src/lib/dashboard/career-prep-dashboard-data-helpers.ts | src/components/dashboard/career-current-info-source-panel.tsx<br>src/components/dashboard/career-dashboard-v1.tsx<br>src/components/dashboard/career-evidence-linkage-panel.tsx<br>src/components/dashboard/career-prep-foundation-panel.tsx<br>src/components/dashboard/career-proposed-action-visibility-panel.tsx<br>src/components/dashboard/career-state-boundary-panel.tsx<br>src/components/dashboard/interviews-dashboard-v1.tsx<br>src/components/dashboard/networking-dashboard-v1.tsx<br>src/components/dashboard/resume-dashboard-v1.tsx | yes | yes |  |  |
| Learning / projects / knowledge | 10 / 15 / 16 | PASS | /learning of [/learning]<br>/projects of [/projects]<br>/knowledge of [/knowledge] | chat_sessions<br>knowledge_items<br>knowledge_links<br>knowledge_tags<br>learning_sessions<br>memory_links<br>project_bugs<br>project_links<br>project_memory_state<br>project_milestones<br>project_releases<br>project_tests<br>projects<br>voice_sessions<br>web_source_links | chat_sessions ← src/lib/repositories/core-read.ts<br>learning_sessions ← src/lib/repositories/core-read.ts<br>projects ← src/lib/repositories/core-read.ts<br>project_milestones ← src/lib/repositories/core-read.ts<br>project_bugs ← src/lib/repositories/core-read.ts<br>project_tests ← src/lib/repositories/core-read.ts<br>project_releases ← src/lib/repositories/core-read.ts<br>project_links ← src/lib/repositories/core-read.ts<br>web_source_links ← src/lib/repositories/current-info-read.ts<br>knowledge_items ← src/lib/repositories/memory-knowledge-read.ts<br>knowledge_tags ← src/lib/repositories/memory-knowledge-read.ts<br>knowledge_links ← src/lib/repositories/memory-knowledge-read.ts<br>retrieval_logs ← src/lib/repositories/memory-knowledge-read.ts<br>memory_usage_logs ← src/lib/repositories/memory-knowledge-read.ts<br>memory_retrieval_events ← src/lib/repositories/memory-knowledge-read.ts<br>table_name ← src/lib/repositories/memory-knowledge-read.ts<br>carnos_context_snapshots ← src/lib/repositories/memory-knowledge-read.ts<br>carnos_entity_state ← src/lib/repositories/memory-knowledge-read.ts<br>memory_candidates ← src/lib/repositories/memory-knowledge-read.ts<br>memory_items ← src/lib/repositories/memory-knowledge-read.ts | src/lib/dashboard/learning-project-dashboard-data-helpers.ts<br>src/lib/voice/voice-session-helpers.ts | src/components/dashboard/career-evidence-linkage-panel.tsx<br>src/components/dashboard/cross-dashboard-links.tsx<br>src/components/dashboard/health-body-linkage-panels.tsx<br>src/components/dashboard/knowledge-vault-alignment-v1.tsx<br>src/components/dashboard/knowledge-vault-foundation-panel.tsx<br>src/components/dashboard/knowledge-vault-source-bridge-panel.tsx<br>src/components/dashboard/learning-academy-dashboard-v1.tsx<br>src/components/dashboard/learning-project-detail-panels.tsx<br>src/components/dashboard/learning-project-linkage-panels.tsx<br>src/components/dashboard/learning-project-summary-panel.tsx<br>src/components/dashboard/project-builder-dashboard-v1.tsx<br>src/components/dashboard/project-system-state-memory-panel.tsx | yes | yes |  |  |
| Research / Stanford / PhD | 11–12 / 16 | PASS | /research-lab of [/research OR /research-lab]<br>/research-stanford, /world-class of [/stanford OR /research-stanford OR /world-class] | memory_review_queue<br>phd_application_assets<br>phd_readiness_assessments<br>research_citations<br>research_claims<br>research_experiments<br>research_feedback<br>research_ideas<br>research_literature_items<br>research_paper_versions<br>research_papers<br>research_questions<br>research_results<br>research_submissions<br>research_venues<br>web_source_audit_events<br>web_source_candidates<br>web_source_links<br>web_sources | web_sources ← src/lib/repositories/current-info-read.ts<br>web_source_candidates ← src/lib/repositories/current-info-read.ts<br>web_source_links ← src/lib/repositories/current-info-read.ts<br>web_source_audit_events ← src/lib/repositories/current-info-read.ts<br>memory_review_queue ← src/lib/repositories/memory-knowledge-read.ts<br>research_ideas ← src/lib/repositories/research-read.ts<br>research_questions ← src/lib/repositories/research-read.ts<br>research_literature_items ← src/lib/repositories/research-read.ts<br>research_citations ← src/lib/repositories/research-read.ts<br>research_claims ← src/lib/repositories/research-read.ts<br>research_experiments ← src/lib/repositories/research-read.ts<br>research_results ← src/lib/repositories/research-read.ts<br>research_papers ← src/lib/repositories/research-read.ts<br>research_paper_versions ← src/lib/repositories/research-read.ts<br>research_venues ← src/lib/repositories/research-read.ts<br>research_submissions ← src/lib/repositories/research-read.ts<br>research_feedback ← src/lib/repositories/research-read.ts<br>target_universities ← src/lib/repositories/research-read.ts<br>target_labs ← src/lib/repositories/research-read.ts<br>target_professors ← src/lib/repositories/research-read.ts | src/lib/dashboard/research-stanford-dashboard-data-helpers.ts | src/components/actions/proposed-action-review-card.tsx<br>src/components/dashboard/career-current-info-source-panel.tsx<br>src/components/dashboard/career-evidence-linkage-panel.tsx<br>src/components/dashboard/current-info-review-to-save-panel.tsx<br>src/components/dashboard/current-info-web-source-audit-trail-panel.tsx<br>src/components/dashboard/knowledge-vault-source-bridge-panel.tsx<br>src/components/dashboard/memory-inbox-preview-panel.tsx<br>src/components/dashboard/research-current-info-source-panel.tsx<br>src/components/dashboard/research-detail-panels.tsx<br>src/components/dashboard/research-linkage-boundary-panels.tsx<br>src/components/dashboard/research-proposed-action-visibility-panel.tsx<br>src/components/dashboard/research-summary-panel.tsx | yes | yes |  |  |
| Health / body / nutrition / sleep / emotion / hair skincare | 13–14 | WARN | /body of [/body]<br>/nutrition of [/nutrition]<br>/sleep-energy of [/sleep-energy]<br>/emotion of [/emotion]<br>/hair-skincare of [/hair-skincare]<br>/supplements of [/supplements] | body_logs<br>emotion_logs<br>energy_logs<br>haircare_logs<br>meal_items<br>mental_health_logs<br>nutrition_logs<br>skincare_logs<br>sleep_logs<br>supplement_logs<br>supplements<br>workout_sets<br>workouts | body_logs ← src/lib/repositories/health-body-read.ts<br>workouts ← src/lib/repositories/health-body-read.ts<br>exercises ← src/lib/repositories/health-body-read.ts<br>workout_sets ← src/lib/repositories/health-body-read.ts<br>nutrition_logs ← src/lib/repositories/health-body-read.ts<br>meal_items ← src/lib/repositories/health-body-read.ts<br>supplements ← src/lib/repositories/health-body-read.ts<br>supplement_logs ← src/lib/repositories/health-body-read.ts<br>sleep_logs ← src/lib/repositories/health-body-read.ts<br>energy_logs ← src/lib/repositories/health-body-read.ts<br>mental_health_logs ← src/lib/repositories/health-body-read.ts<br>emotion_logs ← src/lib/repositories/health-body-read.ts<br>journal_entries ← src/lib/repositories/health-body-read.ts<br>skincare_logs ← src/lib/repositories/health-body-read.ts<br>haircare_logs ← src/lib/repositories/health-body-read.ts<br>products ← src/lib/repositories/health-body-read.ts | src/lib/dashboard/health-body-dashboard-data-helpers.ts | src/components/dashboard/health-body-action-boundary-panels.tsx<br>src/components/dashboard/health-body-dashboard-states.tsx<br>src/components/dashboard/health-body-dashboard-v1.tsx<br>src/components/dashboard/health-body-detail-panels.tsx<br>src/components/dashboard/health-body-emotion-dashboard-v1.tsx<br>src/components/dashboard/health-body-hair-skincare-dashboard-v1.tsx<br>src/components/dashboard/health-body-linkage-panels.tsx<br>src/components/dashboard/health-body-nutrition-dashboard-v1.tsx<br>src/components/dashboard/health-body-sleep-energy-dashboard-v1.tsx<br>src/components/dashboard/health-body-supplements-dashboard-v1.tsx | no | yes |  | Matched route(s) do not show direct runtime read signal. They may delegate to imported helpers/components. |
| Life admin / finance / housing / documents | 13 / 15 | WARN | /life-admin of [/life-admin]<br>/finance of [/finance]<br>/housing of [/housing]<br>/documents of [/documents] | budget_categories<br>documents<br>financial_accounts<br>housing_contacts<br>housing_options | financial_accounts ← src/lib/repositories/admin-finance-read.ts<br>budget_categories ← src/lib/repositories/admin-finance-read.ts<br>financial_logs ← src/lib/repositories/admin-finance-read.ts<br>subscriptions ← src/lib/repositories/admin-finance-read.ts<br>documents ← src/lib/repositories/admin-finance-read.ts<br>housing_options ← src/lib/repositories/admin-finance-read.ts<br>housing_contacts ← src/lib/repositories/admin-finance-read.ts<br>reminders ← src/lib/repositories/admin-finance-read.ts | src/lib/dashboard/admin-finance-dashboard-data-helpers.ts | src/components/dashboard/admin-finance-dashboard-v1.tsx | no | yes |  | Matched route(s) do not show direct runtime read signal. They may delegate to imported helpers/components. |
| Grimoire | 15 | WARN | /grimoire of [/grimoire] | grimoire_corruption_checks<br>grimoire_daily_logs<br>grimoire_modes<br>grimoire_reversions<br>grimoire_skills | grimoire_modes ← src/lib/repositories/grimoire-read.ts<br>grimoire_daily_logs ← src/lib/repositories/grimoire-read.ts<br>grimoire_skills ← src/lib/repositories/grimoire-read.ts<br>grimoire_corruption_checks ← src/lib/repositories/grimoire-read.ts<br>grimoire_reversions ← src/lib/repositories/grimoire-read.ts | src/lib/dashboard/grimoire-dashboard-data-helpers.ts | src/components/dashboard/grimoire-dashboard-v1.tsx | no | yes |  | Matched route(s) do not show direct runtime read signal. They may delegate to imported helpers/components. |
| Carnos / chat / voice / memory | 5–6 / 16–17 | PASS | /carnos of [/carnos]<br>/knowledge of [/knowledge]<br>/settings of [/settings] | ai_actions<br>app_settings<br>carnos_context_snapshots<br>carnos_entity_state<br>carnos_profiles<br>chat_messages<br>chat_sessions<br>learning_sessions<br>memory_candidates<br>memory_conflict_groups<br>memory_conflict_members<br>memory_do_not_remember_rules<br>memory_embedding_records<br>memory_events<br>memory_items<br>memory_links<br>memory_preferences<br>memory_retrieval_events<br>memory_review_queue<br>memory_usage_logs | persona_prompt_versions ← src/lib/repositories/carnos-persona-read.ts<br>ai_actions ← src/lib/repositories/core-read.ts<br>chat_sessions ← src/lib/repositories/core-read.ts<br>chat_messages ← src/lib/repositories/core-read.ts<br>networking_interactions ← src/lib/repositories/core-read.ts<br>learning_sessions ← src/lib/repositories/core-read.ts<br>knowledge_items ← src/lib/repositories/memory-knowledge-read.ts<br>knowledge_tags ← src/lib/repositories/memory-knowledge-read.ts<br>knowledge_links ← src/lib/repositories/memory-knowledge-read.ts<br>retrieval_logs ← src/lib/repositories/memory-knowledge-read.ts<br>memory_usage_logs ← src/lib/repositories/memory-knowledge-read.ts<br>memory_retrieval_events ← src/lib/repositories/memory-knowledge-read.ts<br>table_name ← src/lib/repositories/memory-knowledge-read.ts<br>carnos_context_snapshots ← src/lib/repositories/memory-knowledge-read.ts<br>carnos_entity_state ← src/lib/repositories/memory-knowledge-read.ts<br>memory_candidates ← src/lib/repositories/memory-knowledge-read.ts<br>memory_items ← src/lib/repositories/memory-knowledge-read.ts<br>memory_events ← src/lib/repositories/memory-knowledge-read.ts<br>memory_review_queue ← src/lib/repositories/memory-knowledge-read.ts<br>project_memory_state ← src/lib/repositories/memory-knowledge-read.ts | src/lib/dashboard/settings-privacy-dashboard-data-helpers.ts<br>src/lib/voice/voice-session-helpers.ts | src/components/actions/index.ts<br>src/components/actions/pending-updates-drawer.tsx<br>src/components/actions/proposed-action-review-card.tsx<br>src/components/carnos/carnos-boundary-badges.tsx<br>src/components/carnos/carnos-capability-matrix-panel.tsx<br>src/components/carnos/carnos-companion-dock.tsx<br>src/components/carnos/carnos-companion-widget.tsx<br>src/components/carnos/carnos-message-composer.tsx<br>src/components/carnos/carnos-orb.tsx<br>src/components/carnos/carnos-persona-boundary-panel.tsx<br>src/components/carnos/index.ts<br>src/components/dashboard/approved-memory-read-layer-panel.tsx | yes | yes |  |  |
| Current info / web source / knowledge bridge | 16 | PASS | /knowledge of [/knowledge]<br>/privacy of [/privacy]<br>/research-lab of [/research OR /research-lab] | knowledge_items<br>knowledge_links<br>knowledge_tags<br>memory_review_queue<br>web_search_queries<br>web_source_audit_events<br>web_source_candidates<br>web_source_links<br>web_sources | web_search_queries ← src/lib/repositories/current-info-read.ts<br>web_sources ← src/lib/repositories/current-info-read.ts<br>web_source_candidates ← src/lib/repositories/current-info-read.ts<br>web_source_links ← src/lib/repositories/current-info-read.ts<br>web_source_audit_events ← src/lib/repositories/current-info-read.ts<br>knowledge_items ← src/lib/repositories/memory-knowledge-read.ts<br>knowledge_tags ← src/lib/repositories/memory-knowledge-read.ts<br>knowledge_links ← src/lib/repositories/memory-knowledge-read.ts<br>retrieval_logs ← src/lib/repositories/memory-knowledge-read.ts<br>memory_usage_logs ← src/lib/repositories/memory-knowledge-read.ts<br>memory_retrieval_events ← src/lib/repositories/memory-knowledge-read.ts<br>table_name ← src/lib/repositories/memory-knowledge-read.ts<br>carnos_context_snapshots ← src/lib/repositories/memory-knowledge-read.ts<br>carnos_entity_state ← src/lib/repositories/memory-knowledge-read.ts<br>memory_candidates ← src/lib/repositories/memory-knowledge-read.ts<br>memory_items ← src/lib/repositories/memory-knowledge-read.ts<br>memory_events ← src/lib/repositories/memory-knowledge-read.ts<br>memory_review_queue ← src/lib/repositories/memory-knowledge-read.ts<br>project_memory_state ← src/lib/repositories/memory-knowledge-read.ts<br>system_memory_state ← src/lib/repositories/memory-knowledge-read.ts | src/lib/dashboard/current-info-dashboard-data-helpers.ts | src/components/actions/proposed-action-review-card.tsx<br>src/components/dashboard/career-current-info-source-panel.tsx<br>src/components/dashboard/career-evidence-linkage-panel.tsx<br>src/components/dashboard/carnos-current-info-integration-panel.tsx<br>src/components/dashboard/current-context-pack-builder-panel.tsx<br>src/components/dashboard/current-info-privacy-retention-panel.tsx<br>src/components/dashboard/current-info-review-to-save-panel.tsx<br>src/components/dashboard/current-info-ui-components.tsx<br>src/components/dashboard/current-info-web-source-audit-trail-panel.tsx<br>src/components/dashboard/knowledge-vault-alignment-v1.tsx<br>src/components/dashboard/knowledge-vault-foundation-panel.tsx<br>src/components/dashboard/knowledge-vault-source-bridge-panel.tsx | yes | yes |  |  |
| Analytics / experiments | 18 | PASS | /analytics of [/analytics]<br>/experiments of [/experiments] | carnos_context_snapshots<br>events<br>job_application_events<br>memory_events<br>memory_retrieval_events<br>research_experiments<br>spotify_events<br>web_source_audit_events | events ← src/lib/repositories/core-read.ts<br>job_application_events ← src/lib/repositories/core-read.ts<br>web_source_audit_events ← src/lib/repositories/current-info-read.ts<br>memory_retrieval_events ← src/lib/repositories/memory-knowledge-read.ts<br>carnos_context_snapshots ← src/lib/repositories/memory-knowledge-read.ts<br>memory_events ← src/lib/repositories/memory-knowledge-read.ts<br>research_experiments ← src/lib/repositories/research-read.ts<br>spotify_events ← src/lib/repositories/spotify-connector-read-write.ts | src/lib/analytics-experiments/analytics-dashboard-view-model.ts<br>src/lib/analytics-experiments/self-experiment-lab-view-model.ts | src/components/analytics-experiments/analytics-dashboard-ui.tsx<br>src/components/analytics-experiments/self-experiment-lab-ui.tsx<br>src/components/dashboard/metric-tile.tsx | yes | yes |  |  |
| Custom trackers | 19 | PASS | /custom-trackers of [/custom-trackers] |  |  | src/lib/custom-trackers/custom-trackers-dashboard-view-model.ts | src/components/custom-trackers/custom-trackers-dashboard-ui.tsx | no | yes |  |  |
| Privacy / export / connectors / Spotify | 20 | PASS | /privacy of [/privacy]<br>/settings of [/settings] | financial_accounts<br>privacy_settings<br>spotify_connections<br>spotify_events | financial_accounts ← src/lib/repositories/admin-finance-read.ts<br>app_settings ← src/lib/repositories/settings-privacy-read.ts<br>privacy_settings ← src/lib/repositories/settings-privacy-read.ts<br>spotify_connections ← src/lib/repositories/spotify-connector-read-write.ts<br>spotify_events ← src/lib/repositories/spotify-connector-read-write.ts | src/lib/dashboard/settings-privacy-dashboard-data-helpers.ts<br>src/lib/privacy/privacy-dashboard-view-model.ts | src/components/dashboard/current-info-privacy-retention-panel.tsx<br>src/components/dashboard/memory-privacy-rules-panel.tsx<br>src/components/dashboard/settings-privacy-foundation-panel.tsx<br>src/components/privacy/privacy-dashboard-ui.tsx | yes | yes |  |  |
...
| /custom-trackers | src/app/custom-trackers/page.tsx | no | no | yes | no | no |
...
Full machine-readable evidence: `docs/fixtures/full-project-connectivity/phase_0_20_actual_connectivity_v2.json`
