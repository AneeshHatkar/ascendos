...
- Added `src/lib/analytics-experiments/self-experiment-contracts.ts`.
- Updated `src/lib/analytics-experiments/index.ts`.
- Added `docs/fixtures/phase18-analytics-experiments/phase18e_self_experiment_fixture.json`.
- Added `docs/contracts/PHASE_18E_SELF_EXPERIMENT_CONTRACTS.md`.
- Added `docs/qa/PHASE_18E_SELF_EXPERIMENT_SMOKE_CHECKLIST.md`.
...
- Added `src/lib/analytics-experiments/analytics-repository-boundary.ts`.
- Updated `src/lib/analytics-experiments/index.ts`.
- Added `docs/fixtures/phase18-analytics-experiments/phase18g_analytics_repository_boundary_fixture.json`.
- Added `docs/contracts/PHASE_18G_ANALYTICS_REPOSITORY_BOUNDARIES.md`.
- Added `docs/qa/PHASE_18G_ANALYTICS_REPOSITORY_BOUNDARY_SMOKE_CHECKLIST.md`.
...
- Added `src/lib/analytics-experiments/self-experiment-lab-view-model.ts`.
- Added `src/components/analytics-experiments/self-experiment-lab-ui.tsx`.
- Updated `src/app/analytics/page.tsx`.
- Updated `src/lib/analytics-experiments/index.ts`.
- Added `docs/fixtures/phase18-analytics-experiments/phase18l_self_experiment_lab_ui_fixture.json`.
- Added `docs/contracts/PHASE_18L_SELF_EXPERIMENT_LAB_UI.md`.
- Added `docs/qa/PHASE_18L_SELF_EXPERIMENT_LAB_UI_SMOKE_CHECKLIST.md`.
